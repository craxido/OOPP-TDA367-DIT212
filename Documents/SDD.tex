...
\begin{itemize}
    ...
    \item MapMVPInterface: The interfaces which regulate how the classes communicate internaly and how other packages can communicate with the the presenter.
\end{itemize}
